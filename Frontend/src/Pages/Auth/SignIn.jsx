  ...
  const handleSubmit = async (values, { setSubmitting, setFieldError }) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // The user state is already updated in context
        // Redirect will happen after a small delay
        setTimeout(() => {
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          <div className="text-center mb-8">
            ...
            >
              Sign in to Al Hanif Collection
            </motion.p>
          </div>
          ...
          {submitStatus === 'error' && (
            ...
            >
              <div className="flex items-center">
                ...
                <span className="font-medium">Login failed. Please try again.</span>
              </div>
            </motion.div>
          )}
